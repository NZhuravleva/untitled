...
/**
 * Created by SBT-Zhuravleva-NA on 17.09.2017.
 */
public class MyProject {
    ...
    private static final String placeLocator = "//DIV[@class = 'sbrf-div-list-inner --area bp-area header_contacts']/DIV[@class = 'bp-widget bp-ui-dragRoot']/DIV[@class = 'bp-widget-body']/DIV[1]/DIV[@class = 'region-list']/A[@title = 'Москва']/SPAN[@class = 'region-list__name']";
    ...
    public void middle() {
        ...
        ((JavascriptExecutor) ied).executeScript("arguments[0].scrollIntoView(true);", ied.findElement(By.xpath("//DIV[@class = 'sbrf-div-list-inner --area bp-area footer-navholder']")));
